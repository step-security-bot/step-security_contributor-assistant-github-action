...
![build](https://github.com/step-security/contributor-assistant-github-action/workflows/build/badge.svg)
  ...
  CLAAssistant:
    ...
    steps:
      - name: "CLA Assistant"
        ...
        uses: step-security/contributor-assistant-github-action@v2
        env:
        ...
        with:
          ...
          path-to-document: 'https://github.com/<org>/<repo>/blob/main/SAPCLA.md' # e.g. a CLA or a DCO document
...
!![adding-clafile.gif](images/adding-clafile.gif)
...
!![signature-process.gif](images/signature-process.gif)
...
!![signature-storage-file.gif](images/signature-storage-file.gif)
...
!![allowlist.gif](images/allowlist.gif)
...
!![personal-access-token.gif](images/personal-access-token.gif)
...
| --------------------- | ----------- | ----------- |----------------------------------------------------------------------------------------|
| `path-to-document`     | _required_ |  provide full URL `https://<clafile>` to the document which shall be signed by the contributor(s)  It can be any file e.g. inside the repository or it can be a gist. |        |
...
| `allowlist`   | _optional_ | You can specify users and bots to be [added in allowlist](https://github.com/step-security/contributor-assistant-github-action#5-users-and-bots-in-allowlist).  | user1,user2,bot*                                                                       |
